...
namespace McgInterop
{
	...
	public unsafe static partial class BCrypt_dll
	{
					...
					int dwFlags)
		{
			...
			fixed (char* pinned_pszBlobType = pszBlobType)
			{
				...
				fixed (byte* pinned_pbInput = global::McgInterop.McgCoreHelpers.GetArrayForCompat(pbInput))
				{
					...
					// Call to native method
					unsafe___value = global::McgInterop.BCrypt_dll_PInvokes.BCryptImportKey(
		...
		// Signature, BCryptCloseAlgorithmProvider, [fwd] [return] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] System_IntPtr____w64 int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] int__int, 
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		...
		public static uint BCryptCloseAlgorithmProvider(
		...
		// Signature, BCryptDestroyKey, [fwd] [return] [Mcg.CodeGen.BlittableValueMarshaller] uint__unsigned int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] System_IntPtr____w64 int, 
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		...
		public static uint BCryptDestroyKey(global::System.IntPtr hKey)
		{
			// Setup
			uint unsafe___value;
			// Marshalling
			// Call to native method
			unsafe___value = global::McgInterop.BCrypt_dll_PInvokes.BCryptDestroyKey(hKey);
			global::System.Runtime.InteropServices.DebugAnnotations.PreviousCallContainsUserCode();
			// Return
			return unsafe___value;
		}
					...
					int dwFlags)
		{
			...
			// Marshalling
			// Call to native method
			unsafe___value = global::McgInterop.BCrypt_dll_PInvokes.BCryptGenRandom(
								hAlgorithm, 
								((byte*)pbBuffer), 
								cbBuffer, 
								dwFlags
		...
		public static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptOpenAlgorithmProvider(
		...
		public static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptSetProperty(
					...
					int dwFlags)
		{
			...
			fixed (char* pinned_pszProperty = pszProperty)
			{
				...
				fixed (char* pinned_pbInput = pbInput)
				{
					...
					// Call to native method
					unsafe___value = global::McgInterop.BCrypt_dll_PInvokes.BCryptSetProperty(
		...
		public static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptEncrypt(
					...
					int dwFlags)
		{
			...
			fixed (byte* pinned_pbIV = global::McgInterop.McgCoreHelpers.GetArrayForCompat(pbIV))
			{
				unsafe_pbIV = (byte*)pinned_pbIV;
				// Call to native method
				unsafe___value = global::McgInterop.BCrypt_dll_PInvokes.BCryptEncrypt(
		...
		public static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptDecrypt(
					global::Internal.NativeCrypto.SafeKeyHandle__System_Security_Cryptography_Algorithms hKey, 
					byte* pbInput, 
					int cbInput, 
					global::System.IntPtr paddingInfo, 
					...
					int dwFlags)
		{
			...
			fixed (byte* pinned_pbIV = global::McgInterop.McgCoreHelpers.GetArrayForCompat(pbIV))
			{
				unsafe_pbIV = (byte*)pinned_pbIV;
				// Call to native method
				unsafe___value = global::McgInterop.BCrypt_dll_PInvokes.BCryptDecrypt(
									hKey.DangerousGetHandle(), 
									((byte*)pbInput), 
									cbInput, 
									paddingInfo, 
	...
	public unsafe static partial class BCrypt_dll_PInvokes
	{
		...
		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static uint BCryptCloseAlgorithmProvider(
					global::System.IntPtr hAlgorithm, 
					int dwFlags);

		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static uint BCryptDestroyKey(global::System.IntPtr hKey);
		...
		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptOpenAlgorithmProvider(
		...
		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptSetProperty(
		...
		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptEncrypt(
					global::System.IntPtr hKey, 
					byte* pbInput, 
					int cbInput, 
					global::System.IntPtr paddingInfo, 
		...
		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static global::Internal.NativeCrypto.Cng_NTSTATUS__System_Security_Cryptography_Algorithms BCryptDecrypt(
					global::System.IntPtr hKey, 
					byte* pbInput, 
					int cbInput, 
					global::System.IntPtr paddingInfo, 
